...
const DocsLinkCard: React.FC<DocsLinkCardProps> = ({
  ...
  return (
    <div className="bg-card flex flex-1 flex-col justify-between gap-3 rounded-md border p-6">
      <div className="comet-title-xs text-foreground-secondary">{title}</div>
      <div className="gap-3">
        <div className="comet-body-s text-muted-slate mb-4">{description}</div>
